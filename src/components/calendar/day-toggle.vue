<template>
  ...
  >
    ...
    <a
      ...
      :key="index"
      href="#"
      class=" bg-white text-white py-0dt375 px-4 inline-flex font-medium text-sm leading-5 flex-shrink-0 items-center justify-center hover:opacity-80 active:animate-pulse cursor-pointer"
      :class="{
        'rounded-md bg-14-165-233 text-black hover:opacity-120':
          view_type === tab,
      }"
...
const view_type: Ref<string> = ref("month"); //'week' is default
